...
struct clkctl_acpu_speed acpu_max_vdd_tbl[] = {
	{  19200, 950, VOLTAGE_MIN },
	{ 128000, 950, VOLTAGE_MIN },
	{ 245000, 975, VOLTAGE_MIN },
	{ 256000, 975, VOLTAGE_MIN },
	{ 384000, 1000, VOLTAGE_MIN },
	{ 422400, 1000, VOLTAGE_MIN },
	{ 460800, 1025, VOLTAGE_MIN },
	{ 499200, 1050, VOLTAGE_MIN },
	{ 537600, 1050, VOLTAGE_MIN },
	{ 576000, 1075, VOLTAGE_MIN },
	{ 614400, 1100, VOLTAGE_MIN },
	{ 652800, 1125, VOLTAGE_MIN },
	{ 691200, 1150, VOLTAGE_MIN },
	{ 729600, 1175, VOLTAGE_MIN },
	{ 768000, 1200, VOLTAGE_MIN },
	{ 806400, 1225, VOLTAGE_MIN },
	{ 844800, 1250, VOLTAGE_MIN },
	{ 883200, 1250, VOLTAGE_MIN },
	{ 921600, 1275, VOLTAGE_MIN },
	{ 960000, 1275, VOLTAGE_MIN },
	{ 998400, 1275, VOLTAGE_MIN },
	{ 1036800, 1275, 1275 },
	{ 1113600, 1275, 1275 },	
	{ 1267200, 1300, 1300 },	
	{ 0 },
 ...
 */
static void avs_update_voltage_table(short *vdd_table, int max_voltage_freq, int min_voltage_freq)
{
	u32 avscsr;
	int cpu;
	int vu;
	...
	if ((cpu == 3) || (vu == 3) || (l2 == 3)) {
		...
		for (i = 0; i < avs_state.freq_cnt; i++) {
			...
			/* Cap the voltage according to the table */
			if (vdd_table[i] > max_voltage_freq)
				vdd_table[i] = max_voltage_freq;
		}
	} else if ((cpu == 1) && (l2 == 1) && (vu == 1)) {
		if ((cur_voltage - VOLTAGE_STEP >= min_voltage_freq) &&
...
static short avs_get_target_voltage(int freq_idx, bool update_table)
{
	...
	if (update_table)
		avs_update_voltage_table(vdd_table, acpu_max_vdd_tbl[freq_idx].vdd, acpu_max_vdd_tbl[freq_idx].vdd_min);
	...
	if (voltage < acpu_max_vdd_tbl[freq_idx].vdd_min)
	{
		voltage = acpu_max_vdd_tbl[freq_idx].vdd_min;
	}
